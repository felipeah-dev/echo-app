...
import { PredictiveAlert } from "@/components/custom/Predictivealert";
...
export default function DashboardPage() {
  ...
  // Automation rules (mock - in real app would come from backend)
            ...
            {loading && (
              <div className="flex items-center justify-center py-12">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Loading metrics from Google Sheets...</p>
                </div>
              </div>
            )}
              ...
              <>
                    ...
                    <div className="grid gap-6 md:grid-cols-3">
                      <div className="text-center">
                        ...
                        <div className="text-2xl font-bold text-white">
                          ${(metrics.overview.timeSaved.value * 50).toLocaleString()}
                        </div>
                      </div>
                      <div className="text-center">
                        <div className="text-white/70 text-sm mb-1">Total Deal Value</div>
                        <div className="text-2xl font-bold text-white">
                ...
                {metrics.lastDeal && (
                  <Card className="border-2 border-purple-500/20 bg-gradient-to-br from-purple-50 to-pink-50">
                    <CardHeader>
                      <CardTitle className="text-lg">Latest Deal Synced</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="grid sm:grid-cols-4 gap-4">
                        <div>
                          <p className="text-sm text-gray-600 mb-1">Deal ID</p>
                          <p className="font-mono font-semibold">{metrics.lastDeal.dealId}</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-600 mb-1">Customer</p>
                          <p className="font-semibold">{metrics.lastDeal.customer}</p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium">{metrics.lastDeal.timeAgo}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-white/60 text-xs">
          {isCount ? "this week" : trend === "up" ? "increase" : "vs previous"}
        </span>
      </div>
    </div>
  );
